...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Load guests from cloud storage
    async function loadGuests() {
        try {
            const response = await fetch('https://api.jsonbin.io/v3/b/65f8a1231f5677401f2a1234/latest', {
                headers: {
                    'X-Master-Key': '$2a$10$rHwXmJ0KqFTu6wExJGVAW.7w52XjwCJFZSD8oD6/ntyj9rTUCIHXm'
                }
            });
    ...
    // Save guests to cloud storage
    async function saveGuests() {
        try {
            await fetch('https://api.jsonbin.io/v3/b/65f8a1231f5677401f2a1234', {
                method: 'PUT',
                headers: {
